    ...
    <div className="space-y-4">
      ...
      {value && IconComponent && (
        <div className="flex items-center gap-2 p-3 bg-[#F7F9FB] rounded-lg">
          <span className="text-sm text-[#5A5A5A]">Ícone selecionado:</span>
          <IconComponent className="h-5 w-5 text-[#009DE0]" />
          <span className="text-sm font-medium text-[#0C2340]">{value}</span>
        </div>
      )}
    </div>
  )
